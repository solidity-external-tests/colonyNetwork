...
abstract contract IRecovery is ContractRecoveryDataTypes {
  ...
  function setStorageSlotRecovery(uint256 _slot, bytes32 _value) public virtual;

  /// @notice Check whether the supplied slot is a protected variable specific to this abstract contract
  ...
  function checkNotAdditionalProtectedVariable(uint256 _slot) public view virtual;
}
