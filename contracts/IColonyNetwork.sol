...
abstract contract IColonyNetwork is ColonyNetworkDataTypes, IRecovery {
  ...
  function supportsInterface(bytes4 interfaceID) external virtual pure returns (bool status);
  ...
  function getReplacementReputationUpdateLogEntry(address _reputationMiningCycle, uint256 _id) public virtual view returns
  ...
  function getReplacementReputationUpdateLogsExist(address _reputationMiningCycle) public virtual view returns (bool exists);

  /// @notice Get the Meta Colony address.
  /// @return colonyAddress The Meta colony address, if no colony was found, returns 0x0
  function getMetaColony() public virtual view returns (address payable colonyAddress);

  /// @notice Get the number of colonies in the network.
  /// @return count The colony count
  function getColonyCount() public virtual view returns (uint256 count);
  ...
  function isColony(address _colony) public virtual view returns (bool addressIsColony);
  ...
  function getSkill(uint256 _skillId) public virtual view returns (Skill memory skill);
  ...
  function getSkillCount() public virtual view returns (uint256 count);
  ...
  function getReputationMiningSkillId() public virtual view returns (uint256 skillId);
  ...
  function getTokenLocking() public virtual view returns (address lockingAddress);
  ...
  function getColony(uint256 _id) public virtual view returns (address colonyAddress);
  ...
  function getCurrentColonyVersion() public virtual view returns (uint256 version);
  ...
  function getParentSkillId(uint256 _skillId, uint256 _parentSkillIndex) public virtual view returns (uint256 skillId);
  ...
  function getChildSkillId(uint256 _skillId, uint256 _childSkillIndex) public virtual view returns (uint256 skillId);
  ...
  function getReputationMiningCycle(bool _active) public virtual view returns (address repMiningCycleAddress);
  ...
  function calculateMinerWeight(uint256 _timeStaked, uint256 _submissonIndex) public virtual pure returns (uint256 minerWeight);
  ...
  function getColonyVersionResolver(uint256 _version) public virtual view returns (address resolverAddress);
  ...
  function getReputationRootHash() public virtual view returns (bytes32 rootHash);
  ...
  function getReputationRootHashNNodes() public virtual view returns (uint256 nNodes);
  ...
  function getProfileDBAddress(bytes32 node) public virtual view returns (string memory orbitDB);
  ...
  function lookupRegisteredENSDomain(address addr) public virtual view returns(string memory domain);
  ...
  function getENSRegistrar() public virtual view returns (address);
  ...
  function getMiningResolver() public virtual view returns (address miningResolverAddress);
  ...
  function getFeeInverse() public virtual view returns (uint256 _feeInverse);
