...
abstract contract ITokenLocking is TokenLockingDataTypes {
  ...
  function getColonyNetwork() public virtual view returns (address networkAddress);
  ...
  function getTotalLockCount(address _token) public virtual view returns (uint256 lockCount);
  ...
  function getUserLock(address _token, address _user) public virtual view returns (Lock memory lock);
}
