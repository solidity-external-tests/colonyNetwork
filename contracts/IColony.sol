...
abstract contract IColony is ColonyDataTypes, IRecovery {
  ...
  function authority() public virtual view returns (address colonyAuthority);
  ...
  function owner() public virtual view returns (address colonyOwner);
  ...
  function version() public virtual pure returns (uint256 colonyVersion);
  ...
  function finishUpgrade2To3() public virtual;
  ...
  function getColonyNetwork() public virtual view returns (address colonyNetwork);

  /// @notice Get the colony token.
  /// @return tokenAddress Address of the token contract
  function getToken() public virtual view returns (address tokenAddress);
  ...
  function hasUserRole(address _user, uint256 _domainId, ColonyRole _role) public virtual view returns (bool hasRole);
  ...
  function hasInheritedUserRole(address _user, uint256 _domainId, ColonyRole _role, uint256 _childSkillIndex, uint256 _childDomainId)
    public virtual view returns (bool hasRole);
  ...
  function getUserRoles(address who, uint256 where) public virtual view returns (bytes32 roles);
  ...
  function getDomain(uint256 _id) public virtual view returns (Domain memory domain);
  ...
  function getDomainCount() public virtual view returns (uint256 count);
  ...
  /// @param _id Expenditure identifier
  /// @param _newOwner New owner of expenditure
  function transferExpenditure(uint256 _permissionDomainId, uint256 _childSkillIndex, uint256 _id, address _newOwner) public virtual;
  ...
  function getExpenditureCount() public virtual view returns (uint256 count);

  /// @notice Returns an existing expenditure.
  /// @param _id Expenditure identifier
  /// @return expenditure The expenditure
  function getExpenditure(uint256 _id) public virtual view returns (Expenditure memory expenditure);

  /// @notice Returns an existing expenditure slot.
  /// @param _id Expenditure identifier
  /// @param _slot Expenditure slot
  /// @return expenditureSlot The expenditure slot
  function getExpenditureSlot(uint256 _id, uint256 _slot) public virtual view returns (ExpenditureSlot memory expenditureSlot);
  ...
  function getExpenditureSlotPayout(uint256 _id, uint256 _slot, address _token) public virtual view returns (uint256 amount);
  ...
  function getPayment(uint256 _id) public virtual view returns (Payment memory payment);
  ...
  function getPaymentCount() public virtual view returns (uint256 count);
  ...
  function getTaskCount() public virtual view returns (uint256 count);
  ...
  function getTaskChangeNonce(uint256 _id) public virtual view returns (uint256 nonce);
  ...
  function generateSecret(bytes32 _salt, uint256 _value) public virtual pure returns (bytes32 secret);
  ...
  function getTaskWorkRatingSecretsInfo(uint256 _id) public virtual view returns (uint256 nSecrets, uint256 lastSubmittedAt);

  /// @notice Get the rating secret submitted for role `_role` in task `_id`
  /// @param _id Id of the task
  /// @param _role Id of the role, as defined in TaskRole enum
  /// @return secret Rating secret `bytes32` value
  function getTaskWorkRatingSecret(uint256 _id, uint8 _role) public virtual view returns (bytes32 secret);
  ...
  /// @param _childSkillIndex The index that the `_domainId` is relative to `_permissionDomainId`
  function setTaskManagerRole(uint256 _id, address payable _user, uint256 _permissionDomainId, uint256 _childSkillIndex) public virtual;
  ...
  function getTask(uint256 _id) public virtual view returns (
  ...
  function getTaskRole(uint256 _id, uint8 _role) public virtual view returns (Role memory role);
  ...
  function getRewardInverse() public virtual view returns (uint256 rewardInverse);
  ...
  function getTaskPayout(uint256 _id, uint8 _role, address _token) public virtual view returns (uint256 amount);
  ...
  function getRewardPayoutInfo(uint256 _payoutId) public virtual view returns (RewardPayoutCycle memory rewardPayoutCycle);
  ...
  function getFundingPot(uint256 _id) public virtual view returns (
  ...
  function getFundingPotCount() public virtual view returns (uint256 count);
  ...
  function getFundingPotBalance(uint256 _potId, address _token) public virtual view returns (uint256 balance);

  /// @notice Get the assigned `_token` payouts of pot with id `_potId`.
  /// @param _potId Id of the funding pot
  /// @param _token Address of the token, `0x0` value indicates Ether
  /// @return payout Funding pot payout amount
  function getFundingPotPayout(uint256 _potId, address _token) public virtual view returns (uint256 payout);
  ...
  function getNonRewardPotsTotal(address _token) public virtual view returns (uint256 amount);
}
