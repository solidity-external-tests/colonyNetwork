...
abstract contract IRecovery is ContractRecoveryDataTypes {
  ...
  function isInRecoveryMode() public virtual view returns (bool inRecoveryMode);
  ...
  function numRecoveryRoles() public virtual view returns(uint64 numRoles);
  ...
  function checkNotAdditionalProtectedVariable(uint256 _slot) public virtual view;
}
